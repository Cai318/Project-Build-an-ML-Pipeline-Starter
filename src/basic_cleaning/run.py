...
# TODO: In the code below, fill in the data type for each argument. The data type should be str, float or int. DONE
# TODO: In the code below, fill in a description for each argument. The description should be a string. DONE
